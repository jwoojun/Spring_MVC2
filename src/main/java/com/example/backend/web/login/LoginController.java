package com.example.backend.web.login;

import com.example.backend.domain.login.LoginService;
import com.example.backend.domain.member.Member;
import com.example.backend.web.SessionConst;
import com.example.backend.web.session.SessionManager;
...
public class LoginController {
    ...
    @PostMapping("/login")
    public String login_v4(@Valid @ModelAttribute LoginForm form, BindingResult result,
