...
import com.example.backend.web.argumentresolver.Login;
...
public class HomeController {
    ...
    @GetMapping("/")
    public String homeLoginV3ArgumentResolver(@Login Member loinMember, Model model){
        // 세션 관리자저장된 정보 조회
        if(loinMember == null){
            return "home";
        }
        model.addAttribute("member", loinMember);
        return "loginHome";
    }
